...
let ItemAtchar = {
    ...
    goDataList : function (code, gubun) {
        ...
        if ( code == 1 ) {
            ...
            url = "/incom/etcItemApi/clickDataList";
        } else {
    ...
    */
    ...
    ClickItemLogAdd : function(code) {
        ...
        $.ajax({
            url:'/incom/etcItemApi/clickitemIns',
            type: 'post',
            data: {
                incomcd : code,
                clickcnt : '12'
    ...
    MyItemLogAdd : function(code) {
        $.ajax({
            url:'/incom/etcItemApi/myitemIns',
            type: 'post',
            data: {
                incomcd : code
            },
    ...
    MyItemLogDel : function(code) {
        $.ajax({
            url:'/incom/etcItemApi/myitemDel',
            type: 'post',
            data: {
                incomcd : code
            },
