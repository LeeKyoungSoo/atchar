...
import com.lnworks.atchar.incom.service.CarIncomingService;
...
@RestController
@RequestMapping("/incom/carItemApi")
public class CarIncomApiController {

    @Autowired
    CarIncomingService incomingService;
